  ...
  return (
    ...
    >
      {items.map((item, index) => (
        <div
          key={index}
          className="flex flex-col items-start gap-5 rounded-xl border border-gray-50 backdrop-blur-md p-5 shadow-sm transition-shadow hover:shadow-md min-w-[350px]"
          data-aos="fade-up"
